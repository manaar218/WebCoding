...
import S1Ep6 from '../../Assets/S1Ep6.jpg';
...
export default function S1Ep6Card() {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <img src={S1Ep6} className="Episode 06 - Mr. Abhodro Meets Nutritionist" alt="Episode 06 - Mr. Abhodro Meets Nutritionist" height="100%" width="100%" />
            </Grid>

            <Grid item xs={6}>
              <Typography gutterBottom variant="h6" component="h3" className={classes.Text}>
                06. Mr. Abhodro Meets Nutritionist
              </Typography>
            </Grid>
