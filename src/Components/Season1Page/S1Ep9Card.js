...
import S1Ep9 from '../../Assets/S1Ep9.jpg';
...
export default function S1Ep9Card() {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <img src={S1Ep9} className="Episode 09 - Dev's Apology" alt="Episode 09 - Dev's Apology" height="100%" width="100%" />
            </Grid>
