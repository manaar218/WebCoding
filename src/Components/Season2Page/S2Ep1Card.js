...
import S2Ep1 from '../../Assets/S2Ep1.jpg';
...
export default function S2Ep1Card() {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <img src={S2Ep1} className="Episode 01 - The Journey Continues" alt="Episode 01 - The Journey Continues" height="100%" width="100%" />
            </Grid>
