...
import S2Ep4 from '../../Assets/S2Ep4.jpg';
...
export default function S2Ep4Card() {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <img src={S2Ep4} className="Episode 04 - Dev's Decision" alt="Episode 04 - Dev's Decision" height="100%" width="100%" />
            </Grid>
