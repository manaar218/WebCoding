...
import S2Ep6 from '../../Assets/S2Ep6.jpg';
...
export default function S2Ep6Card() {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <img src={S2Ep6} className="Episode 06 - Dev's Parenting Skills" alt="Episode 06 - Dev's Parenting Skills" height="100%" width="100%" />
            </Grid>

            <Grid item xs={6}>
              <Typography gutterBottom variant="h6" component="h3" className={classes.Text}>
                06. Dev's Parenting Skills
              </Typography>
            </Grid>
