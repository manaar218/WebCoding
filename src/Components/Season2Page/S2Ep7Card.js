...
import S2Ep7 from '../../Assets/S2Ep7.jpg';
...
export default function S2Ep7Card() {
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <img src={S2Ep7} className="Episode 07 - Dev And Sonakshi Have An Argument" alt="Episode 07 - Dev And Sonakshi Have An Argument" height="100%" width="100%" />
            </Grid>

            <Grid item xs={6}>
              <Typography gutterBottom variant="h6" component="h3" className={classes.Text}>
                07. Dev And Sonakshi Have An Argument
              </Typography>
            </Grid>
